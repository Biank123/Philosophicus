...
const AboutPage = () => {
  return (
    ...
    <h1>Sobre Mí</h1>
    <p>Hola, soy Bianca de Petris, desarrolladora fullstack apasionada por la tecnología y el aprendizaje continuo. Como también soy profesora de filosofía, he aprendido a valorar la curiosidad y la crítica constructiva, habilidades que aplico en mi trabajo diario en desarrollo web.</p>
    ...
    <a href="/cv/CVBiancadePetris.pdf" download className="download-cv-btn">Descargar Currículum</a>
</section>
